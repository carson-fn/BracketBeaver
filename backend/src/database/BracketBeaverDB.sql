...
\ c bracket_beaver CREATE TABLE users (
...
VALUES ('alice', 'alice123', 'organizer'),
...
CREATE TABLE matches (
    ...
    home_source_match_id INTEGER REFERENCES matches(matchID) ON DELETE
    SET NULL,
        away_source_match_id INTEGER REFERENCES matches(matchID) ON DELETE
    SET NULL,
        winner_team_id INTEGER REFERENCES teams(teamID) ON DELETE
    SET NULL,
